/**
 * function will input a number and return a number after calculating the sum of the even numbers of the input
...
export function sumOfAllEvenNumbersInArray(num: number): number {
    let sum: number = 0;
